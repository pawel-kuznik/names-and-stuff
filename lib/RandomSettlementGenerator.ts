...
/**
 * Generator for random settlement names based on culture
 */
export class RandomSettlementGenerator implements NameGenerator {
    ...
    /**
     * Creates a new RandomSettlementGenerator
    ...
    private async ensureInitialized(): Promise<void> {
        if (!this.initialized) {
            const data = await this.dataProvider.getDataArray(this.culture, Feature.Settlement);
    ...
    /**
     * Generates a random settlement name for the specified culture
     * @returns A randomly selected settlement name
     */
