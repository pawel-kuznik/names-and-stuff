...
/**
 * Generator for random hamlet names based on culture
 */
export class RandomHamletGenerator implements NameGenerator {
    ...
    /**
     * Creates a new RandomHamletGenerator
    ...
    private async ensureInitialized(): Promise<void> {
        if (!this.initialized) {
            const data = await this.dataProvider.getDataArray(this.culture, Feature.Hamlet);
    ...
    /**
     * Generates a random hamlet name for the specified culture
     * @returns A randomly selected hamlet name
     */
