...
/**
 * Generator for random shrubbery names based on culture
 */
export class RandomShrubberyGenerator implements NameGenerator {
    ...
    /**
     * Creates a new RandomShrubberyGenerator
    ...
    private async ensureInitialized(): Promise<void> {
        if (!this.initialized) {
            const data = await this.dataProvider.getDataArray(this.culture, Feature.Shrubbery);
    ...
    /**
     * Generates a random shrubbery name for the specified culture
     * @returns A randomly selected shrubbery name
     */
