...
/**
 * Generator for random person first names based on culture
 */
export class RandomPersonFirstNameGenerator implements NameGenerator {
    ...
    /**
     * Creates a new RandomPersonFirstNameGenerator
    ...
    private async ensureInitialized(): Promise<void> {
        if (!this.initialized) {
            const data = await this.dataProvider.getDataArray(this.culture, Feature.FirstName);
    ...
    /**
     * Generates a random first name for the specified culture
